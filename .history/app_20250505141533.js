...
const aluguelDeCarros = () => {
    ...
    switch (tipoDeCarro) {
        ...
        console.log(`O preço do km foi R$${kmsPercorridos} e você pagará um total de R$${(kmsPercorridos * precoKm).toFixed(2)}`);
        break;

        case 'luxo':
        precoKm = kmsPercorridos > 200 ? 0.25 : 0.30;
        console.log(`O preço do km foi R$${kmsPercorridos} e você pagará um total de R$${(kmsPercorridos * kmsPercorridos).toFixed(2)}`);
    }
};
